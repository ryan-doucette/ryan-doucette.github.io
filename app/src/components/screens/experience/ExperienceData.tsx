...
import webEquityImg from "./images/webequity-img.png";
...
const experienceItems: experienceItem[] = [
  {
    ...
    description:
      "I start my internship at Smartsheet in May 2022. More details coming soon!",
    image: smartsheetImg,
  ...
  },
  {
    ...
    description:
      "ScrutinyFB is an iOS application that I developed with Shanmukha Srinvisan in 2019. The idea behind the app was to allow users to derive interesting patterns between players and fields. eg. How does Tom Brady play away against the Steelers? It was my (and Shan's) first introduction to React Native and the development lifecycle of a mobile app, so I learned a ton from this project. At this point it mainly just serves as a reminder of how far I've come as a developer and designer, as it is no longer up to date.",
    image: scrutinyImg,
    buttonLabel: "ScrutinyFB APP",
    buttonLink: "https://apps.apple.com/us/app/scrutinyfb/id1491261180",
  },
  {
    identifier: "webEquity",
    title: "webEquity",
    subtitle: "NU Design Capstone",
    description:
      "Many people are unaware of the ways that disabled people do not have equal access to the largest publicly available source of information, the web. My design capstone for Northeastern University, is webEquity, a web app experience that aims to educate people on web accessibility through a series of interactive screens. A link has been provided to my interactive prototype of this project.",
    image: webEquityImg,
    buttonLabel: "WEBEQUITY FIGMA",
    buttonLink:
      "https://www.figma.com/file/O3Oarg78my2ZpIEtafSjS4/ARTG-4550---Capstone?node-id=0%3A1&t=h9UICcd1GpKpZXmq-1",
  },
];
